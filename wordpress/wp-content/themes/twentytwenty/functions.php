...
function twentytwenty_register_styles() {
	...
	// Add Bootsnipp 35V6b Search Bar CSS.
	$bootsnipp_css = '
		...
		body .bootsnipp-search-form,
		body form.search-form.bootsnipp-search-form {
		...
		body .bootsnipp-search-form .card-body {
		...
		body .bootsnipp-search-form .col-auto {
		...
		body .bootsnipp-search-form .col {
		...
		body .bootsnipp-search-form .search-icon {
		...
		body .bootsnipp-search-form label.screen-reader-text {
		...
		body .bootsnipp-search-form input.search-field,
		body .bootsnipp-search-form input.form-control-borderless {
		...
		body .bootsnipp-search-form input.search-field:focus,
		body .bootsnipp-search-form input.form-control-borderless:focus {
			border: none !important;
			outline: none !important;
			box-shadow: none !important;
			background: transparent !important;
		}
		body .bootsnipp-search-form input.search-field::placeholder,
		body .bootsnipp-search-form input.form-control-borderless::placeholder {
			color: #6c757d !important;
			opacity: 1 !important;
			font-size: 1.2rem !important;
			font-weight: 400 !important;
		}
		body .bootsnipp-search-form button.search-submit,
		body .bootsnipp-search-form button.btn-success {
		...
		body .bootsnipp-search-form button.search-submit:hover,
		body .bootsnipp-search-form button.btn-success:hover {
			color: #ffffff !important;
			background: #218838 !important;
			background-color: #218838 !important;
			border-color: #1e7e34 !important;
		}
		body .bootsnipp-search-form button.search-submit:focus,
		body .bootsnipp-search-form button.btn-success:focus,
		body .bootsnipp-search-form button.search-submit:active,
		body .bootsnipp-search-form button.btn-success:active {
			color: #ffffff !important;
		...
		/* Task 5: Search Result Cards (TDC FIT News Layout) */
		...
		.search-result-thumbnail img.search-result-img {
			width: 100% !important;
			height: 100% !important;
		...
		.search-result-card:hover .search-result-thumbnail img.search-result-img {
		...
		.search-result-title a {
			color: #1a5ca4 !important;
			text-decoration: none !important;
			transition: color 0.15s ease !important;
		}
		.search-result-title a:hover {
			color: #0d3c70 !important;
	...
	';
	wp_add_inline_style( 'twentytwenty-style', $bootsnipp_css );

	// Enqueue Font Awesome for Bootsnipp search bar.
	wp_enqueue_style( 'font-awesome-5', 'https://use.fontawesome.com/releases/v5.1.0/css/all.css', array(), '5.1.0' );
